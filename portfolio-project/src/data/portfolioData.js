import { Radio, DoorOpen, Users, GraduationCap, Wrench, Telescope, Rocket } from "lucide-react";

/* =========================================================================
   PORTFOLIO DATA CONFIG
   Everything content-related lives here so it can be edited without
   touching any component markup. Swap real values in before deploying
   (resume link, live social links, email, project URLs).
   ========================================================================= */
...
export const PROFILE = {
  ...
  resumeUrl: "#", // TODO: replace with hosted resume PDF URL
  email: "contact@ishanshukla.dev", // TODO: replace with real email
  social: {
    github: "https://github.com/", // TODO: replace with real GitHub URL
    linkedin: "https://linkedin.com/", // TODO: replace with real LinkedIn URL
  },
};
...
export const EDUCATION = {
  ...
  grad: "Expected 2026", // TODO: confirm graduation year
};
...
export const PROJECTS = [
  {
    ...
    description:
      "A browser-based communication and file-sharing platform that finds everyone on the same public network — a hostel, an event, a lecture hall — and drops them into a temporary, anonymized local room. Messages relay over Socket.io; files move directly between browsers over WebRTC data channels, so nothing large ever touches a server.",
    tech: ["React.js", "Node.js", "Express.js", "Socket.io", "WebRTC", "JavaScript"],
    live: "#",
    repo: "#",
    featured: true,
    icon: Radio,
  ...
  },
  {
    ...
    description:
      "Replaces the manual, signature-chasing gate-pass process with a structured digital workflow. Requests move through coordinator and warden approval in sequence, and every issued pass carries a unique ID and a live status any warden can check at the gate.",
  ...
  },
  {
    ...
    description:
      "A responsive site for the Abhyudaya Science & Literary Club covering events, team, galleries, and blog posts, built to be handed off to non-technical club members for ongoing content updates.",
  ...
  },
  {
    ...
    description:
      "A platform concept aimed at semi-urban and rural students navigating college admissions — verified institutional listings, live seat-availability alerts, multilingual support, and guided documentation, in one place instead of a dozen scattered PDFs.",
...
export const SKILLS = {
  ...
  Tools: ["Git", "GitHub", "VS Code", "Netlify", "Firebase"],
};
